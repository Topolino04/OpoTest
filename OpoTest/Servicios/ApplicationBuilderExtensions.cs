...
namespace OpoTest.Services
{
    public static class ApplicationBuilderExtensions
    {
        ...
        public class Updater
        {
            ...
            //{
            //    PermissionPolicyRole userRole = ObjectSpace.FirstOrDefault<PermissionPolicyRole>(
            //        u => u.Name == DefaultUserRoleName);
            //    if (userRole == null)
            //    {
            ...
            //            t => t.Title.Contains(protectedDepartment),
            ...
            //        userRole.AddTypePermissionsRecursively<Employee>(
            //            SecurityOperations.Read,
            //            SecurityPermissionState.Allow);
            //        userRole.AddTypePermissionsRecursively<Employee>(
            ...
            //        userRole.AddObjectPermissionFromLambda<Employee>(
            ...
            //            Department department = ObjectSpace.FirstOrDefault<Department>(
            //                d => d.Title == departmentTitle,
            //                true);
            //            if (department == null)
            //            {
